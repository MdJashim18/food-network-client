...
const Footer = () => {
    return (
        <footer className="footer bg-base-300 text-base-content p-6 lg:p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <aside className="flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <p className="text-sm lg:text-base mb-4 max-w-xs opacity-80">
                            Serving delicious meals made with love and the freshest ingredients since 2010.
                        </p>
                    ...
                    <nav className="text-center md:text-left">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3 justify-center md:justify-start">
                                ...
                                <span className="text-sm">hello@flavorfusion.com</span>
                            </div>
                        </div>
                    </nav>
