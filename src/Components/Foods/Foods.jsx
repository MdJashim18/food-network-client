...
const Foods = ({ food }) => {
    ...
    const handleAddFavorite = (e) => {
        ...
        fetch('https://food-network-api.vercel.app/favorites', {
            method: 'POST',
            headers: {
    ...
    return (
        <div className=''>
            <div className="card bg-gradient-to-br from-white to-gray-50 w-80 shadow-xl hover:shadow-2xl transition-all duration-500  border border-gray-100 rounded-2xl overflow-hidden group">
